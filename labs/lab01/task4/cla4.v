...
module cla4(
  ...
  wire t20, t21;
  and #(2,2) (t20, p1, g0);
  and #(2,2) (t21, p1, p0, cin);
  or  #(2,2) (c2, g1, t20, t21);

  // Carry c3
  wire t30, t31, t32;
  and #(2,2) (t30, p2, g1);
  and #(2,2) (t31, p2, p1, g0);
  and #(2,2) (t32, p2, p1, p0, cin);
  or  #(2,2) (c3, g2, t30, t31, t32);

  // Carry c4 / cout
  wire c4;
  wire t40, t41, t42, t43;
  and #(2,2) (t40, p3, g2);
  and #(2,2) (t41, p3, p2, g1);
  and #(2,2) (t42, p3, p2, p1, g0);
  and #(2,2) (t43, p3, p2, p1, p0, cin);
  or  #(2,2) (c4, g3, t40, t41, t42, t43);

  // Sum
  xor #(2,2) (sum[0], p0, cin);
  xor #(2,2) (sum[1], p1, c1);
  xor #(2,2) (sum[2], p2, c2);
  xor #(2,2) (sum[3], p3, c3);
